[![Open in Visual Studio Code](https://classroom.github.com/assets/open-in-vscode-2e0aaae1b6195c2367325f4f02e2d04e9abb55f0b24a779b69b11b9e10269abc.svg)](https://classroom.github.com/online_ide?assignment_repo_id=18422170&assignment_repo_type=AssignmentRepo)
# SE_Day1
...
It provides and promotes efficiency in terms of workflow in the industry
making the software work as expected providing reliability
security and scalability as also important aspects of software development 

Identify and describe at least three key milestones in the evolution of software engineering.
process
artificial intelligence complexity and machines such as robotics automation 
...
Waterfall is Linear and sequential, each phase is completed before moving on. 
...
Project Manager - assembles and leads the software development team.
 ...
 - create the roadmap for the project.
...
Draw a picture of car
Draw a full-body portrait of a saloon car with white color, in a parking lot.
Clarity: The improved prompt specifies what is being asked (a saloon car white color in the parking lot) rather than just a "car.
Specific Details: Describing the car's appearance (white color, in the parking lot) and the setting (parking lot ) gives clear guidance on the image to be created.
